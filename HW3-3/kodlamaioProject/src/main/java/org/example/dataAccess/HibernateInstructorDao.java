    ...
    public void update(Instructor instructor) {
        for (Instructor instructor1 : instructors) {
            if (instructor1.getId() == instructor.getId()) {
                ...
                System.out.println("Updated in database with Hibernate : " + instructor.getFirstName()+" "+ instructor.getLastName());
                return;
            }
        }
        System.out.println("teacher not found with Hibernate");
    }

    @Override
    public void delete(Instructor instructor) {
        instructors.remove(instructor);
        System.out.println("teacher is deleted in database with Hibernate");
    }
